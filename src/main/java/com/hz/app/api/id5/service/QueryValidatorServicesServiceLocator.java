...
public class QueryValidatorServicesServiceLocator extends org.apache.axis.client.Service implements QueryValidatorServicesService {
    ...
    public QueryValidatorServicesServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for QueryValidatorServices
    private String QueryValidatorServices_address = "http://gboss.id5.cn/services/QueryValidatorServices";

    public String getQueryValidatorServicesAddress() {
        return QueryValidatorServices_address;
    }

    // The WSDD service name defaults to the port name.
    private String QueryValidatorServicesWSDDServiceName = "QueryValidatorServices";

    public String getQueryValidatorServicesWSDDServiceName() {
        return QueryValidatorServicesWSDDServiceName;
    }

    public void setQueryValidatorServicesWSDDServiceName(String name) {
    ...
    public void setQueryValidatorServicesEndpointAddress(String address) {
